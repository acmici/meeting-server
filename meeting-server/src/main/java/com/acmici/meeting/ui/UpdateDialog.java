...
public class UpdateDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jTextField1.setText(meetingServer.getTopic());
        jTextField2.setText(meetingServer.getMembers());
        jTextField3.setText(meetingServer.getRecorder());
        jTextField4.setEditable(false);
        jTextField4.setText(meetingServer.getFile_path());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                UpdateDialog dialog = new UpdateDialog(new javax.swing.JFrame(), true, null);
